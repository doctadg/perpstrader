...
class DataManager {
     ...
     */
    async getActiveStrategiesForSymbol(symbol) {
        try {
         ...
         ORDER BY updatedAt DESC`);
            ...
            logger_1.default.error(`Failed to get active strategies for ${symbol}:`, error);
            return [];
        }
    }
    /**
     ...
     */
    async getBestActiveStrategyForSymbol(symbol) {
