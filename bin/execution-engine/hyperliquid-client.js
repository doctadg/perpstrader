...
class HyperliquidClient {
    ...
    ORDER_COOLDOWN_MS = 10000; // 10 seconds standard (was 5s)
    MIN_ORDER_COOLDOWN_MS = 5000; // 5 seconds absolute minimum between any orders
    EXTENDED_COOLDOWN_MS = 300000; // 5 minutes after multiple failures
    CANCEL_COOLDOWN_BASE_MS = parsePositiveIntEnv('HYPERLIQUID_CANCEL_COOLDOWN_BASE_MS', 15000);
    CANCEL_COOLDOWN_MAX_MS = parsePositiveIntEnv('HYPERLIQUID_CANCEL_COOLDOWN_MAX_MS', 180000);
