...
exports.generateTokenImageProgrammatic = generateTokenImageProgrammatic;
exports.generateTokenImageDalle = generateTokenImageDalle;
exports.generateTokenImage = generateTokenImage;
 ...
 */
async function generateTokenImageProgrammatic(symbol, name) {
    const size = 512;
    const cx = size / 2;
    const cy = size / 2;
 ...
 */
async function generateTokenImageDalle(symbol, name, apiKey, baseUrl) {
...
async function generateTokenImage(symbol, name, config) {
