...
exports.FillModels = exports.PositionCalculator = exports.OrderBookBuilder = exports.FillModel = void 0;
...
class FillModel {
    ...
    rng;
    latencyConfig;
    constructor(fillConfig = {}, latencyConfig = {}) {
        this.config = {
     ...
     */
    simulateMarketOrder(order, book) {
        const fills = [];
        const side = order.side === 'BUY' ? 'asks' : 'bids';
        const levels = [...book[side]].sort((a, b) => order.side === 'BUY' ? a.price - b.price : b.price - a.price);
     ...
     */
    calculateCommission(price, quantity, liquiditySide) {
...
class OrderBookBuilder {
     ...
     */
    static fromMarketData(data, depth = 10) {
     ...
     */
    static updateBook(book, priceChange) {
...
exports.OrderBookBuilder = OrderBookBuilder;
/**
...
class PositionCalculator {
     ...
     */
    static applyFills(currentQty, currentAvgPx, fills) {
        let qty = currentQty;
     ...
     */
    static detectZeroCrossing(currentQty, fill) {
        const fillQty = fill.side === 'BUY' ? fill.quantity : -fill.quantity;
...
//# sourceMappingURL=fill-models.js.map