...
async function runOpenRouterAnalysis(data) {
    ...
    if (!openrouter_service_1.default.canUseService()) {
        logger_1.default.warn('[AnalyzeNode] OpenRouter API key missing, using heuristic fallback');
        return null;
    }
    ...
    try {
        ...
        if (status === 429) {
            logger_1.default.warn(`[AnalyzeNode] OpenRouter 429 rate limited, skipping AI for this token`);
