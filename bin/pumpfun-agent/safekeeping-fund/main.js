            ...
            try {
                ...
                const stateData = JSON.stringify({
                    ...
                    aiAnalysis: {
                        ...
                        anomalies: (result.detectedAnomalies || []).map((a) => ({ severity: a.severity, type: a.type, description: a.description })),
                    },
                ...
                logger_1.default.warn('[SafekeepingAgent] Failed to cache state:', cacheErr);
            }
            // Log summary
