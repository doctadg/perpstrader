...
exports.englishConfidence = englishConfidence;
...
function detectLanguage(text) {
    ...
    if (NON_ENGLISH_PATTERNS.chinese.test(sample))
        return 'zh';
    if (NON_ENGLISH_PATTERNS.japanese.test(sample))
        return 'ja';
    if (NON_ENGLISH_PATTERNS.korean.test(sample))
        return 'ko';
    if (NON_ENGLISH_PATTERNS.russian.test(sample))
        return 'ru';
    if (NON_ENGLISH_PATTERNS.arabic.test(sample))
        return 'ar';
    if (NON_ENGLISH_PATTERNS.thai.test(sample))
        return 'th';
