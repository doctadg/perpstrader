...
export type SubEventType = 'seizure' | 'approval' | 'launch' | 'hack' | 'sanction' | 'earnings' | 'price_surge' | 'price_drop' | 'breakout' | 'partnership' | 'listing' | 'delisting' | 'merger' | 'acquisition' | 'proposal' | 'ruling' | 'protest' | 'conflict' | 'governance' | 'stablecoin_peg' | 'liquidation_cascade' | 'oracle_exploit' | 'bridge_exploit' | 'smart_contract' | 'whale_alert' | 'etf_flow' | 'regulation' | 'other';
