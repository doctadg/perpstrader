...
exports.topicGenerationNode = topicGenerationNode;
        ...
        try {
            ...
            if (topicResult && topicResult.topic) {
                ...
                if (validation.valid) {
                    ...
                    logger_1.default.debug(`[TopicGenerationNode] Rejected topic "${topicResult.topic}": ${validation.reason}`);
                    skipped++;
 ...
 */
function buildTopicPrompt(article) {
 ...
 */
function parseTopicResponse(content, article) {
    try {
        ...
        logger_1.default.debug(`[TopicGenerationNode] Failed to parse topic response: ${error}`);
        return null;
    }
}
/**
 ...
 */
function validateTopic(topic, articleTitle) {
 ...
 */
function generateFallbackTopic(article) {
...
//# sourceMappingURL=topic-generation-node.js.map