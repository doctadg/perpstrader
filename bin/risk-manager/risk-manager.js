...
class RiskManager {
    maxPositionSize;
    maxDailyLoss;
    maxLeverage = 20; // CRITICAL FIX: Set to 20x max (was 10x, previously 40x)
    ...
    DAILY_LOSS_CIRCUIT_BREAKER_USD = 50; // hard daily stop in dollars
    DAILY_LOSS_ALERT_1_USD = 40; // critical approach threshold 1
    DAILY_LOSS_ALERT_2_USD = 45; // critical approach threshold 2
