...
// Configuration
const PRIVATE_KEY = process.env.HYPERLIQUID_PRIVATE_KEY || 'REDACTED_PRIVATE_KEY';
const WALLET_ADDRESS = process.env.HYPERLIQUID_MAIN_ADDRESS || 'REDACTED_WALLET_ADDRESS';
const DESTINATION_ADDRESS = process.argv[2] || 'REDACTED_DESTINATION_ADDRESS'; // Default to main wallet
