...
export interface TitleTemplate {
  full: string;       // Full descriptive title
  medium: string;     // Medium length for cards/lists
  short: string;      // Short for compact displays
  ticker: string;     // Very short for tickers/scrolling
}
...
const TEMPLATES: Record<SubEventType, TitleTemplate> = {
 ...
 */
export function getTemplate(eventType: SubEventType): TitleTemplate {
 ...
 */
export function generateTitleFromTemplate(
 ...
 */
function formatPriceValue(entity: NumericalEntity): string {
 ...
 */
function formatAmountValue(entity: NumericalEntity): string {
 ...
 */
export function getPositiveMovementTemplate(): TitleTemplate {
  return {
 ...
 */
export function getNegativeMovementTemplate(): TitleTemplate {
  return {
 ...
 */
export function getGenericNewsTemplate(): TitleTemplate {
  return {
    full: '{asset}: {reason}',
    medium: '{asset} update',
    short: '{asset} news',
