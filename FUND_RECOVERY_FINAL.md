...
**Investigated Account:** `REDACTED_WALLET_ADDRESS`
...
- **Status:** ✓ VALID
- **Private Key derives:** `REDACTED_WALLET_ADDRESS`
...
```bash
# Default: Withdraw to REDACTED_DESTINATION_ADDRESS
...
```bash
node scripts/recover-funds.js REDACTED_DESTINATION_ADDRESS
```
...
2. **Check Arbiscan:**
   - Visit: https://arbiscan.io/address/REDACTED_WALLET_ADDRESS
